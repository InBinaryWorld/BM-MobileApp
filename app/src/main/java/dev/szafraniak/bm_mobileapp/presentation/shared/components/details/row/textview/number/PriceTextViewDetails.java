...
public class PriceTextViewDetails extends TextViewDetails<BigDecimal, SimpleDetailsConfig<BigDecimal>> {

    public PriceTextViewDetails(LayoutInflater inflater, ViewGroup viewGroup, SimpleDetailsConfig<BigDecimal> config) {
        super(inflater, viewGroup, config);
    }

    @Override
    protected String parseToDisplay(BigDecimal value) {
        return Formatter.safeFormatPrice(value);
    }
